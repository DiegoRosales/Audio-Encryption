...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DES_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 8)
    ...
    "DES\0progressChange\0\0progress"
};
...
void DES::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DES::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DES::progressChange)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DES::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DES.data,
      qt_meta_data_DES,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DES.stringdata))
...
// SIGNAL 0
void DES::progressChange(int _t1)
{
