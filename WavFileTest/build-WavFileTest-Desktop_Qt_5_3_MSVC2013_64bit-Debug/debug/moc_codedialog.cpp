...
#include "../../WavFileTest/DES/codedialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_codeDialog_t, stringdata) + ofs \
...
const QMetaObject codeDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_codeDialog.data,
      qt_meta_data_codeDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_codeDialog.stringdata))
